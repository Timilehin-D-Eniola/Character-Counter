...
export default function Header () {
  return (
    <>
      ...
      {/* Heading */}
      <div className="text-center mt-6 font-logo font-bold text-2xl sm:text-3xl lg:text-[64px] leading-tight min-w-[343px] max-w-[545px] md-full w-[60%] text-pretty md:text-wrap">
